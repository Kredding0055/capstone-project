...
def seed_motorcycles():
    ...
    images_data = [
        ...
        MotorcycleImage(motorcycle_id=1, image_url='/images/cbr500r-red-capstone-2.jpg'),
        ...
        MotorcycleImage(motorcycle_id=2, image_url='/images/blue-yamaha.jpg'),
        MotorcycleImage(motorcycle_id=3, image_url='/images/ninja-green-2.jpg'),
    ]
